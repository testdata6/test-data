...
job("INT-kube-deployer-SERVICENAME") {
     ...
     authenticationToken('INTKUBEstart')
      wrappers {
        preBuildCleanup()
          }
...
//         trigger("INT-main-deployer-k8s") {
         trigger("INT-Data-Provision-Pipeline") {
              block {
           ...
           parameters {
                 ...
                 predefinedProp('NAMESPACE', 'plp-int')
                 ...
                 predefinedProp('MEMORY_LIMIT', 'PODMEMORY_LIMIT')
                 predefinedProp('MEMORY_REQUEST', 'PODMEMORY_REQUEST')
                 predefinedProp('REPLICA_COUNT', '3')
                                }
                   }
            ...
            publishers {
                    extendedEmail {
                       recipientList('Mongo-project-PLP-ScrumMasters, Mongo-project-PLP-DareDevils, Mongo-project-PLP-QA')
                     ...
                     content('$PROJECT_DEFAULT_CONTENT')
                       ...
                       triggers {
                               failure {
                               subject('$DEFAULT_SUBJECT')
                               recipientList('Mongo-project-PLP-Realsteel, Mongo-project-PLP-ScrumMasters, Mongo-project-PLP-QA')
                     content('$PROJECT_DEFAULT_CONTENT')
                               sendTo {
                                   recipientList()
                               }
