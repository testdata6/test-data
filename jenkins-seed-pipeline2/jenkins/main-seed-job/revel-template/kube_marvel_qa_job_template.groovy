...
job("RVL-kube-qa-deployer-SERVICENAME") {
     parameters {
...
//         trigger("Marvel-QA-Data-Provision-Pipeline") {
          trigger("Marvel-QA-main-deployer-k8s") {
              block {
           ...
           parameters {
             ...
             predefinedProp('NAMESPACE', 'plp-qa')
             ...
             predefinedProp('REPLICA_COUNT', '2')
                                }
                   }
