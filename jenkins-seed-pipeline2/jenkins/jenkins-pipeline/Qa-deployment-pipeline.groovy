...
node (){
     ...
     sh 'curl -X GET -v -u plp-jenkins:plp-jenkins@123 http://172.168.0.227:8080/job/QA-Kube-deployer-${serviceName}/lastSuccessfulBuild/api/json 2> /dev/null | jq .displayName > previousVersion.txt'
