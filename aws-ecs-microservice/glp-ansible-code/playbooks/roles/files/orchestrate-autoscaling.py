...
def setupScalableTarget(mode,serviceName,clusterName,roleArn="arn:aws:iam::939393939339:role/ecs-application-autoscale"):
...
def setupServiceScaleoutMem(mode,serviceName,clusterName,roleArn="arn:aws:iam::939393939339:role/ecs-application-autoscale"):
...
def setupServiceScaleoutCPU(mode,serviceName,clusterName,roleArn="arn:aws:iam::939393939339:role/ecs-application-autoscale"):
    """Function to setup scaling policies target"""
    if mode:
...
def setupServiceScaleinMem(mode,serviceName,clusterName,roleArn="arn:aws:iam::939393939339:role/ecs-application-autoscale"):
    """Function to setup scaling policies target"""
    if mode:
...
def setupServiceScaleinCPU(mode,serviceName,clusterName,roleArn="arn:aws:iam::939393939339:role/ecs-application-autoscale"):
    """Function to setup scaling policies target"""
    if mode:
