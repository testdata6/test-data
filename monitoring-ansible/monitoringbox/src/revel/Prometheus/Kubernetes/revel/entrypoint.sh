...
sed -i "s/KUBERNETES_SERVICE_HOST/$KUBERNETES_SERVICE_HOST/g" /etc/prometheus/prometheus.yml
sed -i "s/KUBERNETES_SERVICE_PORT/$KUBERNETES_SERVICE_PORT/g" /etc/prometheus/prometheus.yml
#exec "$@"
...
/bin/prometheus --config.file=/etc/prometheus/prometheus.yml --storage.tsdb.retention=5h
